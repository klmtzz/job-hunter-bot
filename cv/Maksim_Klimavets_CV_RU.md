...
Python-разработчик и инженер по интеграции AI-систем с практическим опытом проектирования асинхронных бэкенд-сервисов (FastAPI), автономных агентов и шлюзов для языковых моделей (LLM API, RAG, MCP). Специализируюсь на создании отказоустойчивой бэкенд-архитектуры, разработке высоконагруженных REST API и автоматизации комплексных пайплайнов обработки данных.

Активно применяю современные инструменты разработки и генеративные агенты (**Claude Code**, AI-assisted workflows) для обеспечения высокой скорости проектирования, авто-тестирования и поставки production-ready кода.

Свободно владею техническим английским (**B2/C1**) и польским (**B2**, государственный сертификат). Обладаю национальной визой D с правом официального трудоустройства в Польше и странах ЕС. Рассматриваю позиции: **Python Backend Developer, AI Integration Engineer, Software Automation Engineer**.
...
**Python & AI Integration Engineer** | Digital Studio / FinTech | 2023 – настоящее время
* Разработка и оптимизация асинхронных бэкенд-сервисов на **FastAPI** и PostgreSQL.
* Проектирование шлюзов для LLM (OpenAI API, Claude, RAG, MCP) и внедрение AI-агентов в бизнес-продукты.
* Автоматизация сбора данных, создание скраперов на `aiogram v3` и `httpx` с пропускной способностью 500+ rps.
* Контейнеризация сервисов в **Docker / Docker Compose**, настройка CI/CD и деплой на облачные Linux VPS.

**Junior Python Backend Developer** | Web Solutions | 2022 – 2023
* Поддержка REST API на **FastAPI / Flask**, обработка больших объемов данных и интеграция сторонних API.
* Оптимизация SQL-запросов (SQLAlchemy / PostgreSQL) и внедрение кэширования через **Redis** ($O(1)$).
* Покрытие кода юнит- и интеграционными авто-тестами (**Pytest**), снижение количества багов на продакшене.
